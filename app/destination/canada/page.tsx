export default function CanadaPage() {
    return (
        <main className="h-[60vh] bg-background flex flex-col items-center justify-center text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground">Canada</h1>
            <p className="mt-4 text-muted-foreground max-w-xl">
                Content for Canada is coming soon. Please check back later or contact us for more information.
            </p>
