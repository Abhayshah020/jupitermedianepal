...
const topImages = [
    { src: "/destinationImages/aus-1.jpeg", alt: "Australia Event 1" },
    ...
    return (
        <main className="bg-background min-h-screen px-6 md:px-16 py-12">
            ...
            <section className="relative w-full h-64 md:h-96 rounded-xl overflow-hidden shadow-lg mb-12">
                <Image src="/media/7.jpeg" alt="Australia" fill className="object-cover" />
                <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                    {/* <h1 className="text-4xl md:text-6xl font-bold text-white">Destination Australia</h1> */}
                </div>
            </section>
            ...
            <section className="max-w-4xl mx-auto mb-12 text-center">
                <h2 className="text-3xl font-serif font-bold text-foreground mb-4">Featuring from AUSTRALIA</h2>
            ...
            <section className="max-w-6xl mx-auto mb-12 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    Jupiter Media Pvt. Ltd. completed different visionary project in AUSTRALIA, USA, UK, AUSTRALIA, China, Bangladesh, Japan successfully, like wise ”DESTINATION AUSTRALIA” TV SERIES has to be better, and bigger. Motivated from our success and learning from our experience, we hope to make this episode of ”DESTINATION AUSTRALIA” TV SERIES more interesting and informative for our audience while we provide even better reach to our partners to provide good return on marketing investment.
                </p>
            </section>

            {/* Why Australia Education */}
            <section className="max-w-6xl mx-auto mb-12 space-y-4">
                <h3 className="text-2xl font-semibold text-foreground">Why AUSTRALIA Education?</h3>
                <p className="text-muted-foreground leading-relaxed">
                    The AUSTRALIA and its universities have an undisputed reputation for academic excellence and quality with thousands of courses available for students, as well as being an ideal destination for many decades for over a million international students from all over the world.There are a variety of reasons why you should consider studying in the AUSTRALIA. Some of these reasons might be exclusively academic for you, but in addition to the high-quality education, you will gain a lot of value from this one-of-a-kind experience, if you choose to study in the AUSTRALIA.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                    The AUSTRALIA is one of the most popular countries to travel to for the purpose of earning an education. Generations of international students have come to the AUSTRALIA for their education, which means that Australian universities have decades of experience in working with international students. In other words, you’ll get the red carpet treatment from the time you start applying until you walk across the stage for your degree.
                    Every university has an international student society that will help you become adjusted to life in the Australia and connect you with other international students.
                </p>
            </section>
            ...
            <section className="max-w-6xl mx-auto my-12 px-6 md:px-0">
                <h3 className="text-2xl font-semibold text-foreground">
                    What do we do on “DESTINATION AUSTRALIA”?
                </h3>

                <div className="text-muted-foreground leading-relaxed">
                    <p>
                        Jupiter Media crew (2/3 people) will visit Australia to feature real stories from Australia, Australian Uni/College & lifestyle. We talk to Nepalese Students, University representatives and cover the most attractive and salable points of the institution. This is for the promotion of Australian Institutions into Nepalese Media. Team will develop documentary of the institution and broadcast on Television along with Social Media like Face book, YouTube, Instagram & Twitter.  This will be an exclusive promotional material prepared by TV crew having an experience of more than 1.5 decades on education field.
                    </p>
                    ...
                    <div className="bg-primary/5 p-6 rounded-xl shadow-lg  my-3">
                        ...
                        <p>Program called “DESTINATION AUSTRALIA” will be aired on super prime time of NEWS 24 Television.</p>
                    </div>
